...
let seguimos = true
let año = 2022
let edad = prompt("le pido porfavor " + nombre + " me escriba en que año nacio ,  19_ _?")
while(seguimos) {
    console.log("su edad es de ", edad - año )
    seguimos = alert("su edad es" + (año - edad) )
if (seguimos  ) {
    edad++  } 
else { (seguimos <= 18)
    alert("Perfecto muchas gracias " + nombre + "!!!")
    }
}
